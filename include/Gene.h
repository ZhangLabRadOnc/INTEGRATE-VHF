...
class Gene {
  ...
  public:
    ...
    int loadGenesFromFile(const char *fileName, TidHandler &th);
    int setGene();
    ...
    int getBestExon(int gid, int pos, int isbkLeft, int &is5p, int &tid, int &strand, int &pos1, int &pos2, string &name, int &exonNum);
